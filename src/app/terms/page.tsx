...
const termsSections = [
  ...
  },
  {
    ...
    body: [
      ...
      "Our AI evaluates communication effectiveness — structure, clarity, and delivery — and is not designed to evaluate or penalize accent, dialect, or cultural speaking style.",
    ],
  },
  {
...
const commitments = [
  ...
  },
  {
    ...
    body: "Fluentia is designed to help you build communication skills through deliberate practice. It is not a substitute for professional coaching, therapy, speech-language pathology, or any form of clinical or psychological assessment. If you have concerns beyond skill practice, seek qualified professional support.",
  },
];
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-[11px] font-bold text-[#00F38D] uppercase tracking-widest whitespace-nowrap">Terms of Service</p>
            <div className="h-px flex-1 bg-white/8" />
          </div>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <div className="h-px flex-1 bg-white/8" />
            <p className="text-[11px] font-bold text-[#00F38D] uppercase tracking-widest whitespace-nowrap">Privacy Policy</p>
            <div className="h-px flex-1 bg-white/8" />
          </div>
          <div className="space-y-8">
